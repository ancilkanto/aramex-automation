<?php
/**
 * Order Shipped email (plain text)
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/order-shipped.php.
 *
...
echo __('Thank you for your order!', 'aramex-automation') . "\n\n";
